...
<body>
    ...
    <div id="mainContainer" class="mx-auto md:pt-4 pt-1 px-4 md:px-0 max-w-5xl text-center container">
        ...
        Seniors On Medicare Can Get Hundreds In Savings. 
        <p></p>
        <strong> Tap Below To Qualify! </strong> </h1>
        ...
        <div>
            <div id="display1" class="md:mt-8 mt-4">
                ...
                <button id="btn-0" class="flex justify-center bg-green-500 hover:bg-green-500 tracking-wide text-white font-bold rounded-2xl w-3/4 mx-auto border-b-2 border-green-500 uppercase shadow-md md:py-6 py-4 md:text-2xl px-6 items-center"> Under 64
                    </button>
    ...
    <script>
        ...
        const setZip = () => {
            ...
            newUrl.searchParams.set('ip_zip', "<?php  ?>");
            window.history.pushState({
                path: newUrl.href
            }, '', newUrl.href);
        };
